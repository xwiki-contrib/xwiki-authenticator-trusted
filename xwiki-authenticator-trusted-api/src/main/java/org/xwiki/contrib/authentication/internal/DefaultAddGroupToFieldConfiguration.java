...
class DefaultAddGroupToFieldConfiguration implements AddGroupToFieldConfiguration
{
    ...
    protected DefaultAddGroupToFieldConfiguration(TrustedAuthenticationConfiguration authConf, String confPrefix)
    {
        ...
        valueRegex = authConf.getCustomProperty(confPrefix + "valueRegex", "^(?<group>[^=]+)=");
        valueFormat = authConf.getCustomProperty(confPrefix + "valueFormat", "{group.fullName}={role}");
    }
    ...
    public static DefaultAddGroupToFieldConfiguration parse(TrustedAuthenticationConfiguration authConf,
        String confPrefix)
    {
        if (authConf.getCustomProperty(confPrefix + PAGE, "").isEmpty()
            && authConf.getCustomProperty(confPrefix + PROPERTY_NAME, "").isEmpty()) {
            DefaultAddGroupToFieldConfiguration conf = new DefaultAddGroupToFieldConfiguration(authConf, confPrefix);
